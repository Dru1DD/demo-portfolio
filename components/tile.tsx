...
export const TileWrapper: FC<WrapperProps> = ({ numOfPages, children }) => {
...
export const TileBackground: FC<TileProps> = ({ children }) => (
    <div className="absolute h-full w-full">
        {children}
    </div>
)

export const TileContent: FC<TileProps> = ({ children }) => (
